...

{
    ...
    public Vector2 movimento2;  //a variavel movimento é uma variavel que armazena os valores do eixo x e y e verifica se e maior ou menor que zero
                                //para poder movimentar o personagem
    ...
    private GameObject P2;  //essa variavel serve para armazenar as informações da posição do Player 1
    GameObject P1;      //e essa variavel serve para armazenar as informações da posição do Player 2  para que eu consiga compara-las
    ...
    void Update()
    {
        ...
        movimento.x = Input.GetAxisRaw("Horizontal2"); // a variavel movimento armazena os eixo x 
        movimento2.x = Input.GetAxisRaw("XboxH2"); //pega os eixo x do controle 
        movimento.y = Input.GetAxisRaw("Vertical2"); // a variavel movimento armazena os eixo y  
        movimento2.y = Input.GetAxisRaw("XboxV2");  //pega o eixo y do controle
        ...
        if (transform.position.x > P1.transform.position.x)        //verifica se a posição do Player1 é maior do que a posição do player 2
        {
